...
// STARTER: the bus is commented out on this branch, so the test bar below
// (buttons that dispatched cart:add-item / cart:open) is commented too —
// nothing would listen. Uncomment together with the bus in Cart.vue.
